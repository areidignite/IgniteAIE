...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const endpoint = `https://bedrock.${awsRegion}.amazonaws.com/foundation-models/${encodeURIComponent(modelId)}`;
    ...
    const modelDetails = await bedrockResponse.json();
    ...
    console.error("Error in get-model-details function:", error);
    return new Response(
      JSON.stringify({
